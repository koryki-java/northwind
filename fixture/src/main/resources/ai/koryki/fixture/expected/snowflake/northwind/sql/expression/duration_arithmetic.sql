...
, o.order_date + INTERVAL '2 day, 4 hour' AS date_plus_clock
, o.delivered_date + INTERVAL '2 day, 4 hour' AS timestamp_plus_clock
, o.order_date + INTERVAL '-2 day, -4 hour' AS negated
FROM
 orders o
WHERE
  o.order_id = 10248