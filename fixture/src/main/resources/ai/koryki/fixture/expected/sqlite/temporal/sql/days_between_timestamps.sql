...
SELECT
  CAST(julianday('2023-01-02 01:00') - julianday('2023-01-01 23:00') AS INTEGER) AS two_hours_over_midnight
, CAST(julianday('2023-01-02 23:00') - julianday('2023-01-01 01:00') AS INTEGER) AS fortysix_hours
, CAST(julianday('2023-01-03 00:00') - julianday('2023-01-01 00:00') AS INTEGER) AS exactly_two_days
, CAST(julianday('2023-01-01 23:00') - julianday('2023-01-02 01:00') AS INTEGER) AS backwards_two_hours
FROM
 check_temporal c