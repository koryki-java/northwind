...
SELECT
  DATEADD(DAY, 2, o.order_date) AS calendar_only
, DATEADD(HOUR, 4, DATEADD(DAY, 2, CAST(o.order_date AS DATETIME2))) AS date_plus_clock
, DATEADD(HOUR, 4, DATEADD(DAY, 2, o.delivered_date)) AS timestamp_plus_clock
, DATEADD(HOUR, -4, DATEADD(DAY, -2, CAST(o.order_date AS DATETIME2))) AS negated
FROM
 orders o
WHERE
  o.order_id = 10248