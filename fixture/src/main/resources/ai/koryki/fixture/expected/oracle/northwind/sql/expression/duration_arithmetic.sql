...
SELECT
  o.order_date + NUMTODSINTERVAL(2, 'DAY') AS calendar_only
, o.order_date + NUMTODSINTERVAL(2, 'DAY') + NUMTODSINTERVAL(4, 'HOUR') AS date_plus_clock
, o.delivered_date + NUMTODSINTERVAL(2, 'DAY') + NUMTODSINTERVAL(4, 'HOUR') AS timestamp_plus_clock
, o.order_date + NUMTODSINTERVAL(-2, 'DAY') + NUMTODSINTERVAL(-4, 'HOUR') AS negated
FROM
 orders o
WHERE
  o.order_id = 10248