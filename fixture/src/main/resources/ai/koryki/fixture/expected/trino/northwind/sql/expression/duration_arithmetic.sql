...
, CAST(o.order_date AS TIMESTAMP) + INTERVAL '2' DAY + INTERVAL '4' HOUR AS date_plus_clock
, o.delivered_date + INTERVAL '2' DAY + INTERVAL '4' HOUR AS timestamp_plus_clock
, CAST(o.order_date AS TIMESTAMP) + INTERVAL '-2' DAY + INTERVAL '-4' HOUR AS negated
FROM
 orders o
WHERE
  o.order_id = 10248