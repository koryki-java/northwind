...
, CAST(date_add('day', c.date_epoch_day, DATE '1970-01-01') AS TIMESTAMP) - INTERVAL '1' DAY - INTERVAL '1' HOUR - INTERVAL '30' MINUTE - INTERVAL '10' SECOND AS minus_1day90min10seconds
FROM
 check_temporal c