...
SELECT
  o.order_id
, CASE WHEN (o.delivered_date >= CAST('2022-07-01T00:00:00' AS DATETIME2) AND o.delivered_date < CAST('2023-01-01T00:00:00' AS DATETIME2)) THEN 'in' ELSE 'out' END AS second_half_2022
FROM
 orders o
WHERE
  o.order_id < 10253
